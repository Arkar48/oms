...
//var_dump($categories);
// if(isset($_GET["id"])){
//     $result = $category_controller->deleteCategory($_GET["id"]);
...
$result_page=$category_controller->getCategoriesPages($page);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a class="btn btn-outline-primary" href="create_category.php">Add new category</a>
                    <!-- Content Row -->
                    <div class="row">
                        
                        
                        <table class="table table-striped" style="width:1000px !important">
                        ...
                        <?php
                            ...
                            for($row=0;$row<count($result_page);$row++){
                                ...
                                echo "<td id='".$result_page[$row]['id']."'><a href='edit_categories.php?id=".$result_page[$row]["id"]."' class='btn btn-outline-warning'>Edit</a><a class='delete btn btn-outline-danger mx-2'>Delete</a></td>";
                                echo "</tr>";
                            }
//<a href='categories.php?id=".$categories[$row]["id"]."' class='btn btn-danger mx-2'>Delete</a>
                        ?>
                        </tbody>
                        </table>
