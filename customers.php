...
if(isset($_GET["id"])){
    ...
    if($result){
        ...
        echo "<script>alert('You cannot delete this customer')</script>";
    }
}
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a class="btn btn-outline-primary" href="create_customer.php">Add new customer</a>
                    <!-- Content Row -->
                    <div class="row">
                        ...
                        <table class="table table-striped" id="dataTable" style="width:1000px !important">
                            ...
                            <?php
                                ...
                                echo "<td> <a href='edit_customer.php?id=".$customers[$row]['id']."' class='btn btn-outline-warning'>Edit</a><a href='customers.php?id=".$customers[$row]['id']."' class='btn btn-outline-danger mx-2'>Delete</a></td>";
                                echo "</tr>";
                                }
                            ?>
                        </table>
